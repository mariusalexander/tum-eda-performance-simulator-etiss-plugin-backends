...
#ifndef SWEVAL_BACKENDS_INSTRUCTIONTRACE_RV32IM_ZICSR_PRINTER_H
#define SWEVAL_BACKENDS_INSTRUCTIONTRACE_RV32IM_ZICSR_PRINTER_H
...
class InstructionTrace_RV32IM_Zicsr_Printer : public Printer
{
public:

  InstructionTrace_RV32IM_Zicsr_Printer();
...
#endif // SWEVAL_BACKENDS_INSTRUCTIONTRACE_RV32IM_ZICSR_PRINTER_H