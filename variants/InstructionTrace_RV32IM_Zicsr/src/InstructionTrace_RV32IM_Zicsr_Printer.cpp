...
extern InstructionPrinterSet* InstructionTrace_RV32IM_Zicsr_InstrPrinterSet;

InstructionTrace_RV32IM_Zicsr_Printer::InstructionTrace_RV32IM_Zicsr_Printer(): Printer("InstructionTrace_RV32IM_Zicsr_Printer", InstructionTrace_RV32IM_Zicsr_InstrPrinterSet)
{}

void InstructionTrace_RV32IM_Zicsr_Printer::connectChannel(Channel* ch_)
{
  InstructionTrace_RV32IM_Zicsr_Channel* channel = static_cast<InstructionTrace_RV32IM_Zicsr_Channel*>(ch_);
...
std::string InstructionTrace_RV32IM_Zicsr_Printer::getPrintHeader(void)
{
