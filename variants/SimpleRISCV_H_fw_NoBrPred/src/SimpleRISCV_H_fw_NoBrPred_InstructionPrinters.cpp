...
InstructionPrinterSet *SimpleRISCV_H_fw_NoBrPred_InstrPrinterSet = new InstructionPrinterSet("SimpleRISCV_H_fw_NoBrPred_InstrPrinterSet");

static InstructionPrinter *instrPrinter_add = new InstructionPrinter(
  SimpleRISCV_H_fw_NoBrPred_InstrPrinterSet,
  "add",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    SimpleRISCV_H_fw_NoBrPred_Printer* printer = static_cast<SimpleRISCV_H_fw_NoBrPred_Printer*>(printer_);
