...
SchedulingFunctionSet* SimpleRISCV_H_fw_NoBrPred_SchedulingFunctionSet = new SchedulingFunctionSet("SimpleRISCV_H_fw_NoBrPred_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction_add = new SchedulingFunction(
  SimpleRISCV_H_fw_NoBrPred_SchedulingFunctionSet,
  "add",
  0,
  [](PerformanceModel* perfModel_){
  SimpleRISCV_H_fw_NoBrPred_PerformanceModel* perfModel = static_cast<SimpleRISCV_H_fw_NoBrPred_PerformanceModel*>(perfModel_);
  // Enter
