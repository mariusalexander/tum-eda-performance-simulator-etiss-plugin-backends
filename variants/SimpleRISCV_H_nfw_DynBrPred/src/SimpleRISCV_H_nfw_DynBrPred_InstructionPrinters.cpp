...
InstructionPrinterSet *SimpleRISCV_H_nfw_DynBrPred_InstrPrinterSet = new InstructionPrinterSet("SimpleRISCV_H_nfw_DynBrPred_InstrPrinterSet");

static InstructionPrinter *instrPrinter_add = new InstructionPrinter(
  SimpleRISCV_H_nfw_DynBrPred_InstrPrinterSet,
  "add",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    SimpleRISCV_H_nfw_DynBrPred_Printer* printer = static_cast<SimpleRISCV_H_nfw_DynBrPred_Printer*>(printer_);
