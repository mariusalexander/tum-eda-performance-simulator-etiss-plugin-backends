...
SchedulingFunctionSet* SimpleRISCV_H_nfw_DynBrPred_SchedulingFunctionSet = new SchedulingFunctionSet("SimpleRISCV_H_nfw_DynBrPred_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction_add = new SchedulingFunction(
  SimpleRISCV_H_nfw_DynBrPred_SchedulingFunctionSet,
  "add",
  0,
  [](PerformanceModel* perfModel_){
  SimpleRISCV_H_nfw_DynBrPred_PerformanceModel* perfModel = static_cast<SimpleRISCV_H_nfw_DynBrPred_PerformanceModel*>(perfModel_);
  // Enter
