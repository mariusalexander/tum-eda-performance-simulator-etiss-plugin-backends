...
void SimpleRISCV_H_fw_DynBrPred_PerformanceModel::connectChannel(Channel* channel_)
{
...
uint64_t SimpleRISCV_H_fw_DynBrPred_PerformanceModel::getCycleCount(void)
{
...
std::string SimpleRISCV_H_fw_DynBrPred_PerformanceModel::getPipelineStream(void)
{
...
std::string SimpleRISCV_H_fw_DynBrPred_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;
  ret_strs << "Enter";
  ret_strs << "," << "IF_stage";
